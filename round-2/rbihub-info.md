...
Organized by Reserve Bank Innovation Hub in collaboration with IIT Delhi.
...
Data Access
The dataset (~16 GB, Apache Parquet format) is available on Kaggle. Download it directly from there.
...
What to Include
All source code used for feature engineering, model training, and inference
Trained model files (weights, serialized models) — these must be included in the ZIP. If your model files cause the archive to exceed 200 MB, host them on GitHub and provide the link in your README.
Code from earlier iterations: Include source code for previous model versions and experiments alongside your final solution. If including all iterations pushes the ZIP beyond 200 MB, package only your latest code in the archive and link to older versions in your README.
A README with:
...
What to Include
Approach: Description of your methodology, feature engineering, and model architecture
Key findings: Insights about mule account patterns discovered in the data
Experiments: Summary of experiments tried, what worked and what didn't
Results: Performance metrics on public/private test sets
Red herring analysis: How you handled potential red herrings and noise in the data
Submission Limit
